                ...
                if len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        if ((int(cls)== 0 or int(cls)== 1) and conf < 0.58) or (int(cls)== 2 and conf < 0.63)  or (int(cls)== 3 and conf < 0.63) or (int(cls)== 6 and conf < 0.9) or(int(cls)==5 and conf < 0.78) or (int(cls)==5 and conf > 0.8 and h<22) :
                            continue 
                        # if ((int(cls)== 0 or int(cls)== 1) and conf < 0.65) or (int(cls)== 2 and conf < 0.7)  or (int(cls)== 3 and conf < 0.7) or (int(cls)== 6 and conf < 0.9) or(int(cls)==5 and conf < 0.78) or (int(cls)==5 and conf > 0.8 and h<22) :
                        #     continue 

                        if save_txt:  # Write to file
                        
                            points = []
                            f.write('img_'+str(re.split('_|\.',txt_path)[1])+',')
                            # for num in xyxy:
